    ...
    <section id="about" className="whoami">
      <animated.div ref={ref} style={springs} className="whoami-box">
        <div className="text-box">
          ...
          <p className="text">
            My name is Madhuri Dhamodey. I'm a software developer based in Bengaluru with Post Graduate  <span className="bold">MCA (Computer Science)</span>. I have a proven track record of designing, developing, and maintaining complex software applications in a competitive startup environment. My expertise in both front-end and back-end development has allowed me to deliver robust solutions that meet clients' specific requirements.
          </p>

          <p className="text">
            With proficiency in <span className="bold">Java, Spring Boot, MySQL, React Native, JavaScript, HTML, CSS </span> and have the technical skills necessary to take on any software development challenge. I am always seeking to expand my knowledge and stay up-to-date with the latest technologies and development practices to ensure the highest quality results for my clients.
          </p>
